                    ...
                    <div class="sf_colsIn col-md-8" data-sf-element="Language Selector &amp; Search" data-placeholder-label="Language Selector &amp; Search">
                        ...
                        <div class="language-selector language-selector-header">
                            <ul class="sf-lang-selector list-inline">
                                <li>
                                    <a data-available-culture="zh" href="{{route('index_zh')}}" class=" header" style="display: inline-block;">中文</a>
                                </li>
                                <li>
                                    <a data-available-culture="en" href="{{route('index')}}" class="selected header" style="display: inline-block;">English</a>
                                </li>
                            </ul>
                        </div>    
                    </div>
            ...
            <div class="row navWrapper" data-sf-element="Row">
                <div class="nav-container">
                    ...
                    <ul class="nav">
                        ...
                        <li class=""><a href="{{route('pos')}}" target="_self">Countries</a></li>
                        ...
                        <div class="inner">
                            <a class="magnific-popup" href="javascript:;" title="Getty ">
                                <img sizes="(max-width: 479px) 280px,
                                    ...
                                    1920px" src="{{asset('pages/who/images/default-source/health-topics/coronavirus/gettyimages-1181575980.jpg')}}" class="single-image" alt="Coronavirus">
                            </a>
                        </div>
                            ...
                            <div class="dynamic-content__sidebar">
                                <div id="dynamic-content__accordion" class="dynamic-content__accordion sf-accordion">
                                    <div class="sf-accordion__panel">
                                        <div class="sf-accordion__title"><a href="javascript:;" class="sf-accordion__trigger-panel">Stay safe <span class="sf-accordion__icon"></span></a></div>
                                        
                                    </div>
                                    <div class="sf-accordion__panel">
                                        <div class="sf-accordion__title"><a href="javascript:;" class="sf-accordion__trigger-panel">Situation updates <span class="sf-accordion__icon"></span></a></div>
                                        
                                    </div>
                                    <div class="sf-accordion__panel">
                                        <div class="sf-accordion__title"><a href="javascript:;" class="sf-accordion__trigger-panel">Research and guidance <span class="sf-accordion__icon"></span></a></div>
