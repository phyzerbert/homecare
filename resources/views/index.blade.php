            ...
            <div class="row navWrapper" data-sf-element="Row">
                <div class="nav-container">
                    ...
                    <ul class="nav" style="display: block;">
                        ...
                        <li class="" style="padding: 0 40px;"><a href="javascript:;" target="_self">Health Topics</a></li>
                        <li class="" style="padding: 0 40px;"><a href="{{route('pos')}}" target="_self">Pre-Order</a></li>
                    </ul>
                ...
                <ul class="nav-mobile" style="display: none;">
                    ...
                    <li class=""><a href="/redirect-pages/mega-menu/countries" target="_self">Pre-Order</a> </li>
                </ul>
            </div>
        </div>
    </header>
        ...
        <div class="bottom-footer">
            <div class="container">
                <div class="row">
                    <div class="col-md-4">    
                        <div class="sf-content-block content-block">
                            <div><a href="javascript:;">Privacy Legal Notice</a></div>    
                        </div>
                    </div>
                    <div class="col-md-4">    
