            ...
            <div class="row navWrapper" data-sf-element="Row">
                <div class="nav-container">
                    <ul class="nav" style="display: block;">                        
                        ...
                        <li class="" style="padding: 0 40px;"><a href="/">Health Topics</a></li>
                        <li class="" style="padding: 0 40px;"><a href="/pos">Pre-Order</a></li>
                    </ul>
                </div>
                ...
                <ul class="nav-mobile" style="display: none;">
                    ...
                    <li class=""><a href="" target="_self">Pre-Order</a> </li>
                </ul>
            </div>
        </div>
    </header>
